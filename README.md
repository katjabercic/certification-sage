...
Certificates for theorem provers. This project follows the same idea as the [certification GAP package](https://github.com/gap-packages/certification) by Olexandr Konovalov and Andrej Bauer.
